...
const NewNote = (props) => {
    ...
    return(
        ...
        <form onSubmit={handleSubmit} className="mx-5 mt-3 lg:items-center flex flex-col">
        ...
        <button className="rounded-md bg-black px-3 py-2 text-sm bg-zinc-400	text-zinc-700	font-extrabold shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black block mx-auto"> ADD NOTE</button>
        </form>
